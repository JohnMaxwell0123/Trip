...
> **当前生产版本**：`RELEASE v3.5 · 2026.09` ｜ **全球直达**：[trip-cts.pages.dev](https://trip-cts.pages.dev) ｜ **主分支 Commit**：`Ready to Push`  
...
3. **环线景点门票速查与军人优待手册 (v3.5 新增)**：
   ...
   - **渠道三级分流与直达通道**：
     ...
     - 🔴 **官方唯一抢票/报备 (3处)**：莫高窟（提前30天07:00抢A类票，微信小程序「莫高窟参观预约网」）、省博（小程序提前预约）、东风航天城（提前3天特许接待报备）；
     - 🟡 **2026 全民免费开放 (1处)**：西宁塔尔寺 2026 年起全面免大门票（微信小程序「青海文旅通」做 0 元实名预约）；
   - **现役与退役军人优待实战作战指南**：
     - 明确免首道大门票核心原则（七彩丹霞、怪树林、嘉峪关、鸣沙山、翡翠湖、茶卡、二郎剑持优待证/军官证均免门票，单人累计立省超 600 元）；
